...
async function main() {
  ...
  const config = `export const STORY_LIBRARY_CONTRACT_ADDRESS = "${storyLibrary.address}";
export const COLLECTIBLES_CONTRACT_ADDRESS = "${collectibles.address}"
  `;

  writeFileSync(
    join(__dirname, "../client/local_contract_addresses.ts"),
    config
  );
}
